$(document).ready(function() {
    ...
    $('#show_hide_password input').on('input', function() {
        ...
        // Senha que exibe "Diário do Kakashi" com link vermelho
        else if (valor === "bestiario") {
            resultado = "Diário do Kakashi";
            link = '<a href="https://www.notion.so/Ideias-254ad92a12318041bd1dc9aeddaf4c50" target="_blank" class="red-link">Bestiário</a>';
            cor = "gold";
        }
